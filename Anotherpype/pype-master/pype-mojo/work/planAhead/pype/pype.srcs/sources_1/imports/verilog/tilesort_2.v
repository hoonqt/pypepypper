...
module tilesort_2 (
  ...
  reg [24:0] M_correct_tile_d, M_correct_tile_q = 1'h0;
  ...
  always @* begin
    ...
    M_correct_tile_d = M_correct_tile_q;
    ...
    if (M_tile1_orientation_q == 3'h5) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000001;
    end
    if (M_tile1_orientation_q != 3'h5) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000001;
    end
    if (M_tile2_orientation_q == 2'h3) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000002;
    end
    if (M_tile2_orientation_q != 2'h3) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000002;
    end
    if (M_tile3_orientation_q == 3'h4) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000004;
    end
    if (M_tile3_orientation_q != 3'h4) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000004;
    end
    if (M_tile4_orientation_q == 3'h4) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000008;
    end
    if (M_tile4_orientation_q != 3'h4) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000008;
    end
    if (M_tile5_orientation_q == 3'h4) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000010;
    end
    if (M_tile5_orientation_q != 3'h4) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000010;
    end
    if (M_tile6_orientation_q == 2'h2) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000020;
    end
    if (M_tile6_orientation_q != 2'h2) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000020;
    end
    if (M_tile7_orientation_q == 1'h0 || M_tile7_orientation_q == 2'h3) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000040;
    end
    if (M_tile7_orientation_q != 1'h0 || M_tile7_orientation_q != 2'h3) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000040;
    end
    if (M_tile8_orientation_q == 1'h0) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000080;
    end
    if (M_tile8_orientation_q != 1'h0) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000080;
    end
    if (M_tile9_orientation_q == 1'h1) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000100;
    end
    if (M_tile9_orientation_q != 1'h1) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000100;
    end
    if (M_tile10_orientation_q == 1'h0) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000200;
    end
    if (M_tile10_orientation_q != 1'h0) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000200;
    end
    if (M_tile11_orientation_q == 2'h3) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000400;
    end
    if (M_tile11_orientation_q != 2'h3) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000400;
    end
    if (M_tile12_orientation_q == 1'h0) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0000800;
    end
    if (M_tile12_orientation_q != 1'h0) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0000800;
    end
    if (M_tile13_orientation_q == 2'h3) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0001000;
    end
    if (M_tile13_orientation_q != 2'h3) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0001000;
    end
    if (M_tile14_orientation_q == 3'h4) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0002000;
    end
    if (M_tile14_orientation_q != 3'h4) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0002000;
    end
    if (M_tile15_orientation_q == 1'h0) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0004000;
    end
    if (M_tile15_orientation_q != 1'h0) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0004000;
    end
    if (M_tile16_orientation_q == 3'h5) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0008000;
    end
    if (M_tile16_orientation_q != 3'h5) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0008000;
    end
    if (M_tile17_orientation_q == 2'h3) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0010000;
    end
    if (M_tile17_orientation_q != 2'h3) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0010000;
    end
    if (M_tile18_orientation_q == 1'h0) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0020000;
    end
    if (M_tile18_orientation_q != 1'h0) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0020000;
    end
    if (M_tile19_orientation_q == 1'h1) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0040000;
    end
    if (M_tile19_orientation_q != 1'h1) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0040000;
    end
    if (M_tile20_orientation_q == 3'h5) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0080000;
    end
    if (M_tile20_orientation_q != 3'h5) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0080000;
    end
    if (M_tile21_orientation_q == 2'h2) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0100000;
    end
    if (M_tile21_orientation_q != 2'h2) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0100000;
    end
    if (M_tile22_orientation_q == 1'h0 || M_tile22_orientation_q == 2'h3) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0200000;
    end
    if (M_tile22_orientation_q != 1'h0 || M_tile22_orientation_q != 2'h3) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0200000;
    end
    if (M_tile23_orientation_q == 1'h1) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0400000;
    end
    if (M_tile23_orientation_q != 1'h1) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0400000;
    end
    if (M_tile24_orientation_q == 2'h3) begin
      M_correct_tile_d = M_correct_tile_q + 25'h0800000;
    end
    if (M_tile24_orientation_q != 2'h3) begin
      M_correct_tile_d = M_correct_tile_q - 25'h0800000;
    end
    if (M_tile25_orientation_q == 1'h0) begin
      M_correct_tile_d = M_correct_tile_q + 25'h1000000;
    end
    if (M_tile25_orientation_q != 1'h0) begin
      M_correct_tile_d = M_correct_tile_q - 25'h1000000;
    end
      ...
      GAME_PLAYING_game_stage: begin
        ...
        case (M_selected_tile_q)
          S1_selected_tile: begin
            ...
            if (M_number_of_wins_q < 3'h5 & M_correct_tile_q == 24'hffffff) begin
  ...
  always @(posedge clk) begin
    ...
    M_correct_tile_q <= M_correct_tile_d;
