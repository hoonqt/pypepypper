...
module shape1draw_10 (
  ...
  always @* begin
    ...
    if (((counterh >= 9'h195 + horizontaloffset & counterh <= 9'h1fb + horizontaloffset)) & ((counterv >= 7'h78 + verticaloffset) & (counterv <= 8'hb4 + verticaloffset))) begin
      if (orientation == 1'h0 | orientation == 3'h4) begin
        oriented = 1'h0;
      end else begin
        if (orientation == 1'h1 | orientation == 2'h3) begin
          oriented = 1'h1;
        end else begin
          if (orientation == 2'h2) begin
            oriented = 2'h2;
          end else begin
            oriented = 2'h3;
          end
      ...
      if (orientation == 2'h3 | orientation == 3'h4) begin
